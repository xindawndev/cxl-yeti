// SDL_MPEG.cpp : Defines the entry point for the console application.
//
...
#ifndef __DARWIN__
    screen = SDL_SetVideoMode(pCodecCtx->width, pCodecCtx->height, 0, SDL_NOFRAME);
#else
...
#ifndef __DARWIN__
    screen = SDL_SetVideoMode(1280, 720, 0, SDL_NOFRAME);
#else
