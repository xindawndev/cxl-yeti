...
void DMRCP_Invoke_AVTransport_Seek(struct UPnPService *service, void (*CallbackPtr)(struct UPnPService *sender,int ErrorCode,void *user),void* _user, unsigned int InstanceID, char* unescaped_Unit, char* unescaped_Target);
