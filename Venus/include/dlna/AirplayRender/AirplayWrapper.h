...
APW_Error APW_Method_SetEventContextMask(               APW instance, APWEventContextSwitch bitFlags);
APW_Error APW_Method_SetDeviceCapabilities(             APW instance, const char * PlayMedia, const char * RecMedia, const char * RecQualityModes);
void      APW_Method_ErrorEventResponse(                void * session, int errorCode, char * errorMessage);
...
APW_Error APW_StateChange_TransportPlaySpeed(           APW instance, char* playSpeed);
APW_Error APW_StateChange_TransportStatus(              APW instance, APWTransportStatus status);
APW_Error APW_StateChange_CurrentTransportActions(      APW instance, unsigned short allowedActions);
APW_Error APW_StateChange_NumberOfTracks(               APW instance, unsigned int maxNumberOfTracks);
...
APW_Error APW_StateChange_CurrentTrackURI(              APW instance, char* trackURI);
APW_Error APW_StateChange_CurrentTrackMetaData(         APW instance, struct CdsObject* trackMetadata);
